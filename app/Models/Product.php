...
class Product extends Model
{
    ...
    protected $fillable = ['category_id','product_code','slug','product_name','short_description','features','specifications','purchase_information','product_faqs','price_usd','discount_percent','final_price_usd','price_note','meta_title','meta_description','datasheet_file','image','status','is_featured'];
